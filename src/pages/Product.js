    ...
    return (
         <div>
             <section className="dashboard">
                        ...
                        <div className="panel-heading appointment-schedule pt-3">
                            ...
                            <div className="col-md-8 text-left">
                                ...
                                <div className="col-md-2">
                                    <button type="button" className="btn-raised btn btn-danger btn-floating position-static" data-toggle="modal" data-target="#addproModal">
                ...
                {/* Modal */}
                <div className="modal fade" id="addproModal" tabIndex={-1} role="dialog" aria-labelledby aria-hidden="true">
