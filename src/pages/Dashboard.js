                    ...
                    <div className="row" data-plugin="matchHeight" data-by-row="true">
                        ...
                        <div className="card card-shadow" id="widgetLineareaOne">
                            ...
                            <div className="mb-20 grey-500">
                                <i className="icon md-long-arrow-up green-500 font-size-16" /> 15%
                                From this yesterday
                            </div>
                        ...
                        <div className="card card-shadow" id="widgetLineareaTwo">
                            ...
                            <div className="mb-20 grey-500">
                                <i className="icon md-long-arrow-up green-500 font-size-16" /> 34.2%
                                From this week
                            </div>
                            <div className="ct-chart h-50">
                               </div>
                        ...
                        <div className="card card-shadow" id="widgetLineareaThree">
                            ...
                            <div className="mb-20 grey-500">
                                <i className="icon md-long-arrow-down red-500 font-size-16" /> 15%
                                From this yesterday
                            </div>
                            <div className="ct-chart h-50">
                                 </div>
                        ...
                        <div className="card card-shadow" id="widgetLineareaFour">
                            ...
                            <div className="mb-20 grey-500">
                                <i className="icon md-long-arrow-up green-500 font-size-16" /> 18.4%
                                From this yesterday
                            </div>
                            <div className="ct-chart h-50">
                                </div>
                            ...
                            <ul className="list-group list-group-full list-group-dividered mb-0">
                                ...
                                <div className="media align-items-center">
                                    ...
                                    <a className="avatar avatar-lg" href="javascript:void(0)">
                                        <img className="img-responsive" src="assets/images/other/5.jpg" alt="..." />
                                    </a>
                                    </div>
                        ...
                        <div className="panel" id="projects-status">
                            ...
                            <table className="table table-striped appointment-table">
                                ...
                                <tr>
                                    <th width="10%">Time</th>
                                    <th width="90%"><span className="dr-name">DR Joe</span></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
